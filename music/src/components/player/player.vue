<template>
  <div class="player" v-show="playlist.length > 0">
      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <span class="time time-r">{{format(currentSong ? currentSong.duration : '')}}</span>
          </div>
          <div class="operators">
    ...
    <audio ref="audio" :src="currentSong ? currentSong.url : ''" @play="ready" @error="error" @timeupdate="updataTime" @ended="end"></audio>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    percent () {
      ...
      // })
      return this.currentTime / (this.currentSong ? this.currentSong.duration : '')
    },
    ...mapGetters([
      'fullScreen',
      'playing',
