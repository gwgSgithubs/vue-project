  ...
  <div class="">
    <pop-wrap title="编辑活动模板" :isShow="true" height="734px" width="1160px" @closePop="closePop">
      ...
      <div class="pop-btn-box">
        ...
        <button class="r-button sub" v-if="step === 2" @click="publishActive">发布活动</button>
        <button class="r-button primary" v-if="step === 2" @click="saveInPublish">保存到未发布</button>
      </div>
    </pop-wrap>
...
import {getEditActiveData} from 'api/active'
export default {
