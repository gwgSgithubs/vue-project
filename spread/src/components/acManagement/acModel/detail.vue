<template lang="html">
  <div class="">
    <pop-wrap title="模板详情" :isShow="true" height="800px" width="1360px" @closePop="closePop">
...
import {reSetActiveVideoList} from 'common/js/common'
...
import {getModelVideoList, getLabelsList, getEditModelData, getModelCharge, getVideoData} from 'api/model'
export default {
