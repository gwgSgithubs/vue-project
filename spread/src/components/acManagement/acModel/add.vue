    ...
    <div class="bak-white act-card">
      ...
      <el-row :gutter="50" class="input-h28">
        <el-col :xl="24" :lg="24">
          ...
          <div class="btn-box">
            <button class="r-button info" @click="cancelModel">取消</button>
            <button class="r-button primary" @click="saveModel">保存到模板</button>
          </div>
        </el-col>
      </el-row>
    </div>
